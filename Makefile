EXECUTABLE=edisk
SOURCES=init.c alloc.c main.c readinputs.c utils.c output.c boundary.c restart.c history.c algo_driver.c implicit.c transport.c rktvd.c star.c poisson.c
